...
template sudoku() {
    ...
    component rangeProofSol = RangeProof(16);
    rangeProofSol.range[0] <== 0;
    rangeProofSol.range[1] <== 9;

    component rangeProofPuzz = RangeProof(32);
    ...
    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {
            ...
            rangeProofPuzz.range[0] <== 0;
            rangeProofPuzz.range[1] <== 9;
            rangeProofPuzz.in <== puzzle[i][j];
            rangeProofPuzz.out === 1;
            rangeProofSol.in <== solution[i][j];
            rangeProofSol.out === 1;
